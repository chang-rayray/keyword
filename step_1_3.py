...
def query_keywords_tool(keywords: str, event: int = None) -> list:
    AD_KEY = "0100000000039e2b17cc615102a8f0992c68c406bfa9203cfdcc6043f9b366eb0ce351e124"  # 검색광고 API '엑세스라이선스' 입력
    AD_SEC = "AQAAAAADnisXzGFRAqjwmSxoxAa/tN9IV+qGRYodMleavmgarQ=="  # 검색광고 API '비밀키' 입력
    AD_CUST_ID = "3313613"  # 검색광고 API 'CUSTOMER_ID' 입력
